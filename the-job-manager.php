 ...
 *
 * @wordpress-plugin
 * Plugin Name: The Job Manager
 * Plugin URI:  http://github.com/patilswapnilv/the-job-manager
 * Description: Enables a job post type, taxonomy and metaboxes.
 * Version:     0.1.0
 * Author:      Swapnil V. Patil
 * Author URI:  http://github.com/patilswapnilv/the-job-manager
 * Text Domain: the-job-manager
 * License:     GPL-2.0+
...
$post_type_registrations = new The_Job_Manager_Registrations;

// Instantiate main plugin file, so activation callback does not need to be static.
$post_type = new The_Job_Manager( $post_type_registrations );
...
$post_type_metaboxes = new The_Job_Manager_Metaboxes;
...
if ( is_admin() ) {
	...
	$post_type_admin = new The_Job_Manager_Admin( $post_type_registrations );
